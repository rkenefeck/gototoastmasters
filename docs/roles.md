...
The main Ah counter presents the oral report the assistant ah counter assists in the tracking and there is a short break to allow for conferring before Aux reports
...
**Being the toastmaster for the evaluation part of the meeting****. **
...
f you want to go above and beyond.
...
We have 2 table topics evaluators and they sit next to each other in the meeting. (to ensure they don’t mix up who is evaluating who)
...
# Sergeant at Arms (S@A) /Force Warden
...
To reward correct answers by handing out small rewards – usually wrapped sweets (not required at GOTO)
...
Ideally the secretary but could be anyone. You need to print everything required for the meeting in the hour before the meeting. We have a printer that we are storing with our supplies at the mail exchange (or in a suitcase if having a non mail exchange meeting like a contest).
